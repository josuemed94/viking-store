...
import 'package:app_ventas_ropa/src/pages/client/update/client_update_controller.dart';
import 'package:app_ventas_ropa/src/pages/register/register_controller.dart';
...
class _ClientUpdatePageState extends State<ClientUpdatePage> {
  ...
  Widget _textFieldLastName() {
    return Container(
      ...
      child: TextField(
        controller: _con.lastnamelController,
        decoration: InputDecoration(
            hintText: 'Apellido',
            border: InputBorder.none,
            contentPadding: EdgeInsets.all(15),
