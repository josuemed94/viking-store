import 'dart:io';
import 'package:app_ventas_ropa/src/models/category.dart';
import 'package:app_ventas_ropa/src/pages/tienda/categories/create/tienda_categories_create_controller.dart';
import 'package:app_ventas_ropa/src/pages/tienda/products/create/tienda_products_create_controller.dart';
import 'package:app_ventas_ropa/src/utils/my_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

class TiendaProductsCreatePage extends StatefulWidget {
  const TiendaProductsCreatePage({Key key}) : super(key: key);

  @override
  _TiendaProductsCreatePageState createState() => _TiendaProductsCreatePageState();
}

class _TiendaProductsCreatePageState extends State<TiendaProductsCreatePage> {

  TiendaProductsCreateController _con = new TiendaProductsCreateController();
